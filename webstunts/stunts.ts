...
/// <reference path="jiglibjs2/geom/Vector3D.ts"/>
/// <reference path="jiglibjs2/geom/Matrix3D.ts"/>

/// <reference path="jiglibjs2/geometry/JTriangleMesh.ts"/>

/// <reference path="jiglibjs2/vehicles/JCar.ts"/>
...
function initMesh(model) {
    ...
    for (var index = 0; index < faceIndices.length; index++) {
...
function buildTrack(codes) {
    ...
    for (var i = 0; i < terrainItems.length; i++) {

...
namespace jiglib {
    ...
    export class CollDetectBoxBox extends CollDetectFunctor {
        ...
        combinationDist: number = null; // Number

        constructor() {
            super("BoxBox", "BOX", "BOX");
        }

        disjoint(out, axis, box0, box1) {
        ...
        getAABox2EdgeIntersectionPoints(contactPoint, origBoxSides, origBoxState, edgePt0, edgePt1) {
        ...
        getBoxBoxIntersectionPoints(contactPoint, box0, box1, newState) {

...
/// <reference path="CollisionSystemGridEntry.ts"/>


module jiglib {
    export class CollisionSystemGrid extends CollisionSystemAbstract {
        gridEntries = null; // CollisionSystemGridEntry
        overflowEntries = null; // CollisionSystemGridEntry
        nx = null; // int
        ny = null; // int
        nz = null; // int
        dx = null; // Number
        ...
        constructor(sx, sy, sz, nx, ny, nz, dx, dy, dz) {
            super();
        ...
        calcGridForSkin6(colBody) {
            ...
            tempStoreObject.i = i; tempStoreObject.j = j; tempStoreObject.k = k;
            tempStoreObject.fi = fi; tempStoreObject.fj = fj; tempStoreObject.fk = fk;
